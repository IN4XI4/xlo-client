            ...
            <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-4">
                    <Dropdown label="" dismissOnClick={true} renderTrigger={() => (
                        ...
                        <Dropdown.Item onClick={() => openModal('Mes Rappels', "Le mode qui vous permet de revoir les histoires que vous avez sauvé à l’aide de l'icône signet sera prochainement disponible.")}>
                            <span className='text-gray-500 flex items-center justify-items-center'>
                                <BiSolidBellRing className='me-3 text-[#3DB1FF]' />
                                Mes rappels</span>
                        </Dropdown.Item>
