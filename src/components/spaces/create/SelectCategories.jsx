  ...
  return (
    <div>
      ...
      <div className='border rounded shadow'>
        <div className='bg-gray-100 py-4 text-gray-500 font-semibold'>
          Pick at least one [category]
        </div>
        {categories.length > 0 && (
          <div className='py-3'>
            <div className='pb-2 border-b mx-3 my-2'>
              <div className={`py-2 rounded-lg cursor-pointer border-2 text-center font-semibold 
            ...
            {categories.map((category) => {
              ...
              return (
                <div
                  key={category.id}
                  className={`mx-3 my-2 py-1 rounded-lg cursor-pointer border-2 text-center ${isSelected
                    ? 'bg-[#3DB1FF] text-white border-gray-200'
                    : 'bg-gray-100 text-[#3DB1FF] border-[#3DB1FF]'
                    }`}
