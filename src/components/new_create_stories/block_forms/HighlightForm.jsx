...
export function HighlightForm({ cardIndex, blockIndex, register, errors, globalMentor, globalSoftskill, showTypeSelector,
  ...
  return (
    <div className='p-2 bg-gray-50 shadow rounded-2xl border-[4px]'
